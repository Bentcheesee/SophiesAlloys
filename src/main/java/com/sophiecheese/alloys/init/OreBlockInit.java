...
//Warped Redstone
		//public static final RegistryObject<Block> WARPED_REDSTONE_NETHER_ORE = register("warped_redstone_nether_ore",
		//		() -> new DropExperienceBlock(NETHERRACK_ORES.strength(3.0f)), 
		//		object -> () -> new BlockItem(object.get(), GeneralItemInit.tabAttributeAlloy()));
		//public static final RegistryObject<Block> WARPED_REDSTONE_SOUL_ORE = register("warped_redstone_soul_ore",
		...
		//		object -> () -> new BlockItem(object.get(), GeneralItemInit.tabAttributeAlloy()));
		//public static final RegistryObject<Block> WARPED_REDSTONE_BLOCK = register("warped_redstone_block", 
		//		() -> new PoweredBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.TERRACOTTA_WHITE)
...
//Crimson Coal
		...
		public static final RegistryObject<Block> CRIMSON_COAL_BLOCK = register("crimson_coal_block",
				() -> new Block(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_BLACK)
					...
					.sound(SoundType.METAL)), 
				object -> () -> new CrimsonCoalBlock(object.get(), GeneralItemInit.tabAttributeAlloy()));
