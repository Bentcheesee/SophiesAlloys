...
public class SuspiciousBlockBlockEntityRenderer implements BlockEntityRenderer<SuspicousBlockBlockEntity> {
	private final ItemRenderer itemRenderer;

	public SuspiciousBlockBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
		this.itemRenderer = context.getItemRenderer();

	}

	public void render(SuspicousBlockBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
	...
	@Override
	public net.minecraft.world.phys.AABB getRenderBoundingBox(SuspicousBlockBlockEntity blockEntity) {
