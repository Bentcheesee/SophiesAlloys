...
@EventBusSubscriber(modid = SophiesAlloys.MOD_ID)
public class DataGenerators {
	...
	public static void gatherData(GatherDataEvent event) {
		...
		BlockTagsProvider blockTagsProvider = new AlloysBlockTagProvider(packOutput, lookupProvider, existingFileHelper);
